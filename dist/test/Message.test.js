...
describe('Message Component', () => {
    ...
    it('renders with different intents - info', () => {
        (0, react_2.render)(react_1.default.createElement(Message_1.Message, { ...defaultProps, intent: Message_1.MessageIntent.kInfo }));
        (0, expect_1.default)(react_2.screen.getByText('Test Title')).toBeTruthy();
        (0, expect_1.default)(react_2.screen.getByText('Test Body')).toBeTruthy();
    });
    it('renders with different intents - warning', () => {
        (0, react_2.render)(react_1.default.createElement(Message_1.Message, { ...defaultProps, intent: Message_1.MessageIntent.kWarning }));
        (0, expect_1.default)(react_2.screen.getByText('Test Title')).toBeTruthy();
        (0, expect_1.default)(react_2.screen.getByText('Test Body')).toBeTruthy();
    });
    it('renders with different intents - error', () => {
        (0, react_2.render)(react_1.default.createElement(Message_1.Message, { ...defaultProps, intent: Message_1.MessageIntent.kError }));
        (0, expect_1.default)(react_2.screen.getByText('Test Title')).toBeTruthy();
        (0, expect_1.default)(react_2.screen.getByText('Test Body')).toBeTruthy();
    });
