 ...
 */
export declare const standardColumnElementStyles: () => Record<"root", string>;
export declare const standardRowElementStyles: () => Record<"root", string>;
...
export declare const standardTextStyles: () => Record<"root" | "normal" | "heading" | "subHeadingLeft" | "normalGrey" | "textarea" | "centredHint" | "centredHintLarge" | "footer", string>;
